...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div 
    ref={ref} 
    className={cn(
      "rounded-xl border border-gray-200/80 dark:border-white/[0.06] bg-white/80 dark:bg-[#141414] text-gray-950 dark:text-gray-50 shadow-sm dark:shadow-none backdrop-blur-sm", 
      className
    )} 
    {...props} 
  />
